"""
Django settings for calcoin_41242 project.
...
ROOT_URLCONF = 'calcoin_41242.urls'
...
WSGI_APPLICATION = 'calcoin_41242.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calcoin_41242 API",
    "DESCRIPTION": "API documentation for calcoin_41242 App",
    "VERSION": "v1",
}
